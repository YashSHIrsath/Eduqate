    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col border-r border-slate-800 shrink-0">
        ...
        <div className="p-6 border-b border-slate-800 flex items-center gap-3">
          <div className="h-9 w-9 bg-violet-600 rounded-lg flex items-center justify-center font-bold text-white shadow-md">
            EQ
          </div>
          <div>
            <span className="font-bold text-white block text-sm tracking-wide">EDUQATE</span>
            <span className="text-[10px] text-violet-400 font-semibold tracking-widest uppercase">Student Portal</span>
          </div>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1">
          <Link
            ...
            activeProps={{ className: 'bg-violet-600/10 text-violet-400 border-l-4 border-violet-500 font-medium' }}
